...
while true; do sudo -n true; sleep 60; kill -0 "$$" || exit; done 2>/dev/null &
	...
	if [ "$ans" == "y" ] || [ "$ans" == "Y" ] || [ "$ans" == "Yes" ] || [ "$ans" == "YES" ]; then
		...
		echo "Target Search Field in iTunes:"
		echo "--------------------"
		...
		echo "--------------------"
		read -p "Make ⌘ + F focus the search input in iTunes? (y/n)> " ans
		if [ "$ans" == "y" ] || [ "$ans" == "Y" ] || [ "$ans" == "Yes" ] || [ "$ans" == "YES" ]; then
	...
	if [ "$ans" == "y" ] || [ "$ans" == "Y" ] || [ "$ans" == "Yes" ] || [ "$ans" == "YES" ]; then
		...
		read -p "Don’t show the preferences window on next start? (y/n)> " ans
		if [ "$ans" == "y" ] || [ "$ans" == "Y" ] || [ "$ans" == "Yes" ] || [ "$ans" == "YES" ]; then
	...
	if [ "$ans" == "y" ] || [ "$ans" == "Y" ] || [ "$ans" == "Yes" ] || [ "$ans" == "YES" ]; then
		...
		read -p "Show the app window when clicking the menu icon? (y/n)> " ans
		if [ "$ans" == "y" ] || [ "$ans" == "Y" ] || [ "$ans" == "Yes" ] || [ "$ans" == "YES" ]; then
			defaults write com.twitter.twitter-mac MenuItemBehavior -int 1
		fi

		read -p "Enable the hidden ‘Develop’ menu? (y/n)> " ans
		if [ "$ans" == "y" ] || [ "$ans" == "Y" ] || [ "$ans" == "Yes" ] || [ "$ans" == "YES" ]; then
			defaults write com.twitter.twitter-mac ShowDevelopMenu -bool true
		fi

		read -p "Open links in the background? (y/n)> " ans
		if [ "$ans" == "y" ] || [ "$ans" == "Y" ] || [ "$ans" == "Yes" ] || [ "$ans" == "YES" ]; then
			defaults write com.twitter.twitter-mac openLinksInBackground -bool true
		fi

		read -p "Allow closing the ‘new tweet’ window by pressing 'Esc'? (y/n)> " ans
		if [ "$ans" == "y" ] || [ "$ans" == "Y" ] || [ "$ans" == "Yes" ] || [ "$ans" == "YES" ]; then
			defaults write com.twitter.twitter-mac ESCClosesComposeWindow -bool true
		fi

		read -p "Show full names rather than Twitter handles? (y/n)> " ans
		if [ "$ans" == "y" ] || [ "$ans" == "Y" ] || [ "$ans" == "Yes" ] || [ "$ans" == "YES" ]; then
			defaults write com.twitter.twitter-mac ShowFullNames -bool true
		fi

		read -p "Hide the app in the background if it’s not the front-most window? (y/n)> " ans
		if [ "$ans" == "y" ] || [ "$ans" == "Y" ] || [ "$ans" == "Yes" ] || [ "$ans" == "YES" ]; then
